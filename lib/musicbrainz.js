...
mb.searchCache = function (uri, src, force, callback, search) {
...
mb.search = function(resource, src, query, filter, force, callback){
	if (typeof callback === 'undefined') {
		callback = force;
		force = false;
	}
	...
	mb.searchCache(uri, src, force, callback, search);
};
